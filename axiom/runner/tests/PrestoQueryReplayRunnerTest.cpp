...
TEST_F(PrestoQueryReplayRunnerTest, joinWithTableScan) {
  ...
  const std::vector<std::string> serializedPlanFragments = {
      /*broadcast*/
      R"({"task_id":"bcd.3.0.0.0","execution_strategy":"UNGROUPED","remote_task_ids":{},"plan_fragment":{"outputType":{"cTypes":[{"type":"BIGINT","name":"Type"}],"names":["b0"],"type":"ROW","name":"Type"},"serdeKind":"Presto","partitionFunctionSpec":{"name":"GatherPartitionFunctionSpec"},"replicateNullsAndAny":false,"sources":[{"names":["b0"],"projections":[{"fieldName":"c0","inputs":[{"type":{"names":["c0"],"cTypes":[{"type":"BIGINT","name":"Type"}],"type":"ROW","name":"Type"},"name":"InputTypedExpr"}],"type":{"type":"BIGINT","name":"Type"},"name":"FieldAccessTypedExpr"}],"sources":[{"assignments":[{"columnHandle":{"requiredSubfields":[],"hiveType":{"type":"BIGINT","name":"Type"},"dataType":{"type":"BIGINT","name":"Type"},"columnType":"Regular","hiveColumnHandleName":"c0","name":"HiveColumnHandle"},"assign":"c0"}],"tableHandle":{"tableParameters":{},"tableName":"U","subfieldFilters":[],"connectorId":"test-hive","name":"HiveTableHandle"},"outputType":{"names":["c0"],"cTypes":[{"type":"BIGINT","name":"Type"}],"type":"ROW","name":"Type"},"id":"4","name":"TableScanNode"}],"id":"5","name":"ProjectNode"}],"keys":[],"kind":"BROADCAST","numPartitions":1,"id":"6","name":"PartitionedOutputNode"}})",
      /*join*/
